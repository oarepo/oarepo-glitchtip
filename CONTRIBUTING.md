...
Report bugs at <https://github.com/oarepo/oarepo-glitchtip/issues>.
...
<https://github.com/oarepo/oarepo-glitchtip/issues>.
...
Ready to contribute? Here's how to set up `oarepo-glitchtip` for local
development.

1. Fork the `oarepo/oarepo-glitchtip` repo on GitHub.

2. Clone your fork locally:

   ```console
   git clone git@github.com:your_name_here/oarepo-glitchtip.git
   ```
